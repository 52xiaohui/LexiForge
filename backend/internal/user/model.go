...
const (
	LearningModeExternalAssist   = "external_assist"
	LearningModeLexiForgePrimary = "lexiforge_primary"
)

// User mirrors the `users` table from docs/core/data-model.md.
...
type User struct {
	...
	LearningMode string     `gorm:"type:varchar(32);not null;default:'external_assist'" json:"learning_mode"`
